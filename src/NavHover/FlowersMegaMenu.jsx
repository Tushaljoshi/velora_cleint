...
import Flower from "../assets/b2.png"

const flowersMenu = [
  {
    title: "In Focus",
    items: [
      { label: "Flowers in 60 mins", badge: true },
      { label: "Explore Floral Elegance" },
      { label: "All Flowers" },
      { label: "Best Sellers" },
      { label: "Same Day Delivery" },
      { label: "New Arrivals" },
      { label: "Personalised Flowers" },
      { label: "Crochet Flowers", badge: true },
      { label: "Premium Flowers" },
      { label: "Zodiac Flowers" },
      { label: "The Timeless Series" },
      { label: "Standing Flower Bouquets" },
      { label: "Flagship Collections" }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Lilies" },
      { label: "Sunflowers" },
      { label: "Dried Flowers", badge: true },
      { label: "Daisies", badge: true }
    ]
  },
  {
    title: "Blossom Arrangement",
    items: [
      { label: "Luxe Flowers", badge: true },
...
export default function FlowersMegaMenu() {
  ...
  return (
    <div className="relative">
      ...
      <div className="hidden lg:flex absolute left-0 w-[1500px] bg-[#f2e5e5] shadow-xl border border-[#e6e6e6] p-6 gap-6 z-50">
        ...
        <img src={Flower} className="absolute bottom-4 right-4 h-[100px] w-[100px]" alt="" />
      </div>
